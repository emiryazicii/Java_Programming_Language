...
public class DivisibleBy {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Enter the number you want to check at last.");
...
/*
reate a class named DivisibleBy and Write a program that can print the numbers between 1 ~ N that can be divisible by 3, 5, and 15.
